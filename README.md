...
You can open all your cypress test, examine and execute them on the cypress dashboard. If you want to execute only one test in a file you can choose it by using cy.only 
